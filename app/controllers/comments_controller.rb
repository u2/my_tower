class CommentsController < ApplicationController
  ...
  before_action :set_todo, only: [:new, :index, :create]
  ...
  # GET /comments/new
  def new
    @comment = Comment.new(commentable_type: 'Todo', commentable_id: params[:todo_id])
  end
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to @todo, notice: 'Comment was successfully updated.' }
  ...
  def destroy
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to todo_url(@todo), notice: 'Comment was successfully destroyed.' }
